...
///////////////////////////////////////////////////////////////////////////////////////////////////
			 ...
			 // Step 5: Capture and validate MessageCenterNotification.json API
/*
		try
			{
			...
			for (LogEntry entry : logs) {
			    ...
			    // Look for the API call in the log entry
			    if (message.contains("MessageCenterNotification.json")) {
			        apiFound = true;

			        // Extract status code (if present)
			        if (message.contains("\"status\":200")) {
			            status200Found = true;
			            break; //Found what we need, no need to keep checking
			        }
			    }
			}
			...
			if (!apiFound) {
			    ...
			    System.out.println("MessageCenterNotification.json found, but Status NOT 200. Check headers manually.");
			}
			...
			{
				System.out.println("Valiation: MessageCentreNotification Api not found ::Fail");
			}
		*/
			try
			{
