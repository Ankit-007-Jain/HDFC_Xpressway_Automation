...
//    To validate newly added festive logo
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////
 ///Locating text: Fixed Deposit using Funds from HDFC Bank
 WebElement headingText01= driver.findElement(By.xpath("//*[@id=\"parentPanel\"]/div[2]/div[1]/p"));
 String headingText02= headingText01.getText().trim();
 
 Actions fdCTA =new Actions(driver);
 fdCTA.moveToElement(headingText01).perform();
 
 if(headingText02.equals("Fixed Deposit using Funds from HDFC Bank"))
 {
	WebElement clickBookFD= driver.findElement(By.xpath("//*[@id=\"offerCardLink--cta\"]/div/p/a"));
	clickBookFD.click();
 }
